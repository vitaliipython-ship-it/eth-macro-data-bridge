...
def validate_g1(root: Path = ROOT) -> None:
    ...
    for marker in (
        ...
        "EXACT_IMPLEMENTATION_PATH_COUNT=20", "NEW_PATH_COUNT=0",
    ...
    try:
        ...
        need(declared_scope_count == 20, "G2A_FROZEN_SCOPE_DECLARED_COUNT")
        need(len(parsed_scope_paths) == 20, "G2A_FROZEN_SCOPE_PARSED_COUNT")
        need(len(set(parsed_scope_paths)) == 20, "G2A_FROZEN_SCOPE_DUPLICATE_PATH_COUNT")
...
def main() -> int:
    ...
    print("G2A_EXACT_IMPLEMENTATION_PATH_COUNT=20")
    print("G2A_PARSED_IMPLEMENTATION_PATH_COUNT=20")
    ...
    print("G2A_BINANCE_SPOT_HOST_OWNER_PATH_COUNT=2")
    print("G2A_S3_HOST_BINDING_TEST_SCOPE_EXPANSION_PATH_COUNT=1")
    print("G2A_HTTP_451_PROVIDER_SPECIFIC_SEMANTICS=NOT_NORMATIVELY_DOCUMENTED")
