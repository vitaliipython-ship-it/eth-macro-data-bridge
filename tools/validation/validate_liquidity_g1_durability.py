...
def validate_g1(root: Path = ROOT) -> None:
    ...
    for marker in (
        ...
        "EXACT_IMPLEMENTATION_PATH_COUNT=17", "NEW_PATH_COUNT=0",
    ...
    try:
        ...
        need(declared_scope_count == 17, "G2A_FROZEN_SCOPE_DECLARED_COUNT")
        need(len(parsed_scope_paths) == 17, "G2A_FROZEN_SCOPE_PARSED_COUNT")
        need(len(set(parsed_scope_paths)) == 17, "G2A_FROZEN_SCOPE_DUPLICATE_PATH_COUNT")
...
def main() -> int:
    ...
    print("G2A_EXACT_IMPLEMENTATION_PATH_COUNT=17")
    print("G2A_PARSED_IMPLEMENTATION_PATH_COUNT=17")
