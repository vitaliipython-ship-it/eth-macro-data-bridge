"""
Публичная runtime composition boundary F3.
...
from .composition import LifecycleComponent, ServerRuntimeDependencies

__all__ = ["LifecycleComponent", "ServerRuntimeDependencies"]
