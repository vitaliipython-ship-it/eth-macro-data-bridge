...
```text
CURRENT_PROGRAM_FRONTIER=F5C_C9_TARGET_STATE_SSOT_HARDENED_REAUTHORIZED_OWNER_AUDIT_REQUIRED
...
C9_STARTED=NO
F5C_C9_STATUS=AUTHORIZED_PRE_EXECUTION
F5C_C9_STARTED=NO
REAL_PROVIDER_FORWARD_COLLECTION_STARTED=NO
READY_FOR_F5C_C9_OWNER_AUTHORIZATION=CONSUMED_PASS
F5C_C9_OWNER_EXECUTION_AUTHORIZATION=AUTHORIZED_FRESH_EXACT_HEAD
...
```text
NEXT_OWNER_TASK=F5C_C9_TARGET_STATE_SSOT_HARDENED_REAUTHORIZED_OWNER_AUDIT
NEXT_RECOMMENDED_TASK=OWNER_AUDIT_TARGET_STATE_SSOT_AND_C9_REAUTHORIZED_SUCCESSOR
STOP_CODE=F5C_C9_TARGET_STATE_SSOT_HARDENED_REAUTHORIZED_OWNER_AUDIT_REQUIRED
NEXT_OWNER_ACTION=OWNER_AUDIT_TARGET_STATE_SSOT_AND_C9_REAUTHORIZED_SUCCESSOR
