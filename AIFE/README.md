...
`D8_VPS_PROVENANCE_STATUS=PASS_FRESH_LIVE_SOURCE_IMAGE_CONFIG_BOUND_FOR_C9_AUTHORIZATION`. Fresh live D8 source/image/config readback физически reconciled с historical Git commit и текущей C8/control lineage; repository snapshot alone не использовался как provenance authority.
