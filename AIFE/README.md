...
Эта control projection фиксирует C1 PASS и следующий owner gate C2. Она не авторизует C2 implementation, Docker/VPS mutation, F5M, real AIFE mutation, AEB generation или production cutover.
