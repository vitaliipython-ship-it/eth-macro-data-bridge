...
```text
CURRENT_PROGRAM_FRONTIER=F5C_C9_EXECUTION_ROUTE_SOURCE_REPAIR_REQUIRED
...
MINIMAL_REPAIR_PATH_SET=AIFE/staging/server/runtime/deployment.py;AIFE/staging/server/runtime/c9_forward.py
...
```text
NEXT_OWNER_TASK=F5C_C9_MINIMAL_EXECUTION_ROUTE_SOURCE_REPAIR_OWNER_AUTHORIZATION
NEXT_RECOMMENDED_TASK=OWNER_AUDIT_C9_EXECUTION_ROUTE_BLOCKER_AND_MINIMAL_REPAIR_SCOPE
STOP_CODE=F5C_C9_REAL_PROVIDER_EXECUTION_ROUTE_NOT_MATERIALIZED
NEXT_OWNER_ACTION=OWNER_AUDIT_C9_EXECUTION_ROUTE_BLOCKER_AND_MINIMAL_REPAIR_SCOPE
