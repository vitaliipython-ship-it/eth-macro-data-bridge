...
F5C_C8_PRIVILEGED_EXECUTOR_REPAIR=SOURCE_IMPLEMENTED_AND_QUALIFIED_HOST_BOOTSTRAP_PENDING
...
Эта control projection фиксирует C1/C2/C3/C4/C5/C6/C7 PASS как repository-persisted checkpoint и оставляет C8 за отдельной owner authorization boundary. Она не авторизует C8 execution, VPS mutation, F5M, real AIFE mutation, AEB generation или production cutover.
